...
for basline_ in BASELINES:
    ...
    FPR_diff_smote = [abs(a) for a in df_data.FPR_diff.values.tolist()]
    FPR_diff_after_smote = [abs(a) for a in df_data.FPR_diff_after.values.tolist()]
    SPD_smote = [abs(a) for a in df_data.SPD.values.tolist()]
    SPD_after_smote = [abs(a) for a in df_data.SPD_after.values.tolist()]
    DIR_smote = df_data.DIR.values.tolist()
    DIR_after_smote = df_data.DIR_after.values.tolist()
    AOD_smote = [abs(a) for a in df_data.AOD.values.tolist()]
    AOD_after_smote = [abs(a) for a in df_data.AOD_after.values.tolist()]
